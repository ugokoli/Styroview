...
public class PinCode extends AppCompatEditText {
    ...
    public PinCode(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PinCode(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                ...
                0, 0);
        try {
            setMaskCode(a.getBoolean(R.styleable.PinCode_maskCode, true));
            setFieldShape(a.getInteger(R.styleable.PinCode_fieldShape, 1));
            setDefaultColor(Color.parseColor(a.getString(R.styleable.PinCode_defaultColor)));
            setSelectedColor(Color.parseColor(a.getString(R.styleable.PinCode_selectedColor)));
            setFilledColor(Color.parseColor(a.getString(R.styleable.PinCode_filledColor)));
            setCodeColor(Color.parseColor(a.getString(R.styleable.PinCode_codeColor)));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mMaskCode) {
            maskedText.replace(0, textLength, new String(new char[textLength]).replace("\0", "*"));
        }
